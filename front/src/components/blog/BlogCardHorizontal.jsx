              ...
              <div className="flex items-center   my-10 ">
                <div className="lg:flex min-w-0 lg:flex-1 items-center">
                  <figure className="lg:flex-shrink-0">
                    <img id={index} className="h-64 lg:w-96 w-full object-cover rounded" src={`http://127.0.0.1:8000${data.thumbnail}`} alt="" />
                  </figure>
                  <div className="min-w-0 flex-1 px-8 p-4 ">
                    ...
                    <div className="lg:absolute lg:top-28">
								<span className=" hover:text-orange-500  mx-1 font-medium text-gray-800 text-sm "></span> <Link to={`/category/${data.category.slug}`}>{data.category.name}</Link><span className="text-gray-300">&middot;</span>
                        ...
                        <p className="mt-4 text-lg font-regular text-gray-800 leading-8">{data.description.length > 150 ? data.description.slice(0,149):data.description}
                        </p>
